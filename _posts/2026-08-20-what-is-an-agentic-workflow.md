...
- **Scoped access.** The agent gets the minimum permissions the job requires — the same least-privilege discipline we apply to human admin accounts in our [security practice](/ai-security.html).
