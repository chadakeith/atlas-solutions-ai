...
3. **Write rules people can follow.** A practical [AI policy](/ai-policy.html) — what's encouraged, what needs care, what's prohibited, and who to ask. Pages, not a binder. If your policy can't be understood in one read, it isn't a policy; it's liability theater.
4. **Make the safe path the easy path.** Technical controls, [security monitoring](/ai-security.html), and [training](/ai-training.html) that align what people *can* do with what they *should* do.
